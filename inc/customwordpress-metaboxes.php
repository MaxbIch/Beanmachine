...
// Register "Custom Wordpress" metaboxes

add_filter( 'rwmb_meta_boxes', 'vd_register_customwordpress_meta_boxes' );

function vd_register_customwordpress_meta_boxes($meta_boxes) {
    $meta_boxes[] = [
        'title' => 'Design page additional fields',
        'post_types' => 'page',
        'include' => [
            'template' => ['tmpl-customwordpress.php'],
        ],
        'fields' => [
            [
                'type' => 'heading',
