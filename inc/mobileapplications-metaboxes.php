...
// Register "MobileApplications" metaboxes

add_filter( 'rwmb_meta_boxes', 'vd_register_mobapplications_meta_boxes' );

function vd_register_mobapplications_meta_boxes($meta_boxes) {
    $meta_boxes[] = [
        'title' => 'Design page additional fields',
        'post_types' => 'page',
        'include' => [
            'template' => ['tmpl-mobileapplications.php'],
        ],
        'fields' => [
            [
                'type' => 'heading',
