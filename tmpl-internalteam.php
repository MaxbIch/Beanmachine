<?php /* Template Name: Internal Team Augmentation */ ?>
...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <section class="vd_section vd_design_section vd_ill_section">

        <div class="vd-container">
            <div class="row">
                <div class="col-12 vd-design-col vd-team-col">
    ...
    <img class="saveUI saveIll" src="<?php echo get_template_directory_uri(); ?>/image/LINE.png" alt="">
    ...
    <section class="card-section team-card">
        <div class="vd-container">
            <div class="row">
                <div class="col-12 vd-card-coll-top">
                    <div class="vd-card-design-tittle vd-card-ill-tittle"><?php echo $card_design_tittle; ?></div>
    ...
    <section class="vd_section vd_guide_section vd_ui_section vd_guide_ill_section">
        <div class="vd-container">
            <div class="row">
                <div class="col-12 vd-guide-col vd-ill-col">
                    <h3 class="vd-ui-title vd-ui-ill-title"><?php echo $guide_title; ?></h3>
                    <div class="vd-ui-desc vd-ill-desc"><?php echo $guide_desc; ?></div>
